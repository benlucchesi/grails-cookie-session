...
public class CookieSessionFilter extends OncePerRequestFilter implements InitializingBean, ApplicationContextAware {
    ...
    final static Logger log = LoggerFactory.getLogger(CookieSessionFilter.class.getName());
    ...
    protected void doFilterInternal( HttpServletRequest request, 
      ...
      if( log.isTraceEnabled() ){ log.trace("request type: " + request); }
      if( log.isTraceEnabled() ){ log.trace("response type: " + response); }
      if( log.isTraceEnabled() ){ log.trace("filterchain type: " + chain.getClass().getName()); }
